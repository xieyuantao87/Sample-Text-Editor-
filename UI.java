...
public class UI extends JFrame implements ActionListener {
    ...
    private final JMenuItem newFile, openFile, saveFile, close, cut, copy, paste, clearFile, selectAll, quickFind,
            aboutMe, aboutSoftware, wordWrap, count;
    ...
    public UI() {
        ...
        setTitle(SimpleJavaTextEditor.NAME+ SimpleJavaTextEditor.VERSION);
        ...
        textArea.setFont(new Font("Time New Roman", Font.BOLD, 12));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // word count code
        if(e.getSource()==count) new wordCount(textArea);
        // Find
